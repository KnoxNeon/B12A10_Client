...
const AddService = ({ currentUserEmail = 'user@example.com' }) => {
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className={isPet ? "opacity-50" : ""}>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Price (in USD)
            {!isPet && <span className="text-red-500">*</span>}
          </label>
          <input
            type="number"
            min="0"
            ...
            placeholder={isPet ? "Free adoption (or leave blank)" : "29.99"}
            disabled={isPet}
            required={!isPet}
          ...
          {isPet && (
            <p className="text-xs text-gray-500 mt-1">
              Price is set to $0 for pet adoptions
            </p>
          )}
        </div>
        ...
        {/* Image Upload */}
        <div>
          <label className="flex items-center gap-3 text-gray-700 mb-2 text-sm font-medium">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Available for Pickup From <span className="text-red-500">*</span>
          </label>
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">
            Buyers will contact you at this email
          </p>
        </div>
        ...
        <div className="pt-4">
          <button
            ...
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-lg transition transform hover:scale-105 shadow-md"
          >
            Publish Listing
          </button>
        </div>
