          ...
          <div className="w-full max-w-md">
            <div className="bg-sky-800 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button onClick={googleSignup} className="py-3 px-6 mx-auto bg-sky-900 hover:scale-[1.02] border border-sky-600 rounded-xl text-white font-medium transition-all flex justify-center items-center gap-2">
                    <FcGoogle />Google
                  </button>
              </form>
            </div>
